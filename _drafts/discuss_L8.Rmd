...
### Instructions
After going through the module content, slideshow, and other electronic resources, create an initial thread and respond to the following: 
...
- _Concisely_ compare and contrast the emergence of state-level social organization developed in Mesopotamia, Egypt, and the Aegean.
    + Your analysis should include the major factors, discussed in the lesson module, slideshow, and/or other resources that affected the process in these regions.
    + Did you notice in similarities in state-formation in these regions?
    
- Was there anything, in particular, that you found fascinating about the content in this lesson---either in the module pages, slideshow, or links to additional resources?
...
### Getting Started
To prepare for this discussion, you go over the lesson content, slideshow, and additional web content.

Access the Discussion Forum, "I'm in a City-State of Mind" and follow the instructions above. __For this activity, you must first submit your intial thread _before_ you can view/respond to other posts.__
