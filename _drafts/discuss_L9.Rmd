...
### Instructions
After going through the lesson content, slideshow, and other electronic resources, create an initial thread and respond to the following: 
...
### Getting Started
To prepare for this discussion, you should read through the module pages, access and read content from external web-links, and watch the lecture slideshow.
